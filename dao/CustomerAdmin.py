...
class CustomerAdmin(ICustomerAdmin):
    ...
    def create_customer(self, customer: Customer):
        ...
        stmt = conn.cursor()
        stmt.execute(f"insert into customers (first_name,last_name,dob,email,phone_number,address) VALUES ( '{customer.get_customer_info()['first_name']}', '{customer.get_customer_info()['last_name']}', '{customer.get_customer_info()['dob']}', '{customer.get_customer_info()['email']}', '{customer.get_customer_info()['phone_number']}', '{customer.get_customer_info()['address']}');")
